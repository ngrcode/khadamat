export interface BarbershopSearchParams {
  fromDate?: string;
  toDate?: string;
  globalSearch?: string;
}

export interface BarbershopApiItem {
  id?: number;
  userId?: number | null;
...
export interface BarbershopRow extends BarbershopApiItem {
  fullName: string;
  statusLabel: string;
...
export interface BarbershopListResponse {
  status?: string;
  info?: BarbershopApiItem[] | null;
  data?: BarbershopApiItem[] | null;
  items?: BarbershopApiItem[] | null;
  total?: number;
  totalCount?: number;
  recordsTotal?: number;
