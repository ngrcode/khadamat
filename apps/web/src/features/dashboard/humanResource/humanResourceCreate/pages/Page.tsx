...
import { useGetActiveUnitEmployee } from "../humanResource/organisms/useGetAllRole";
import MultiSelectFormik from "@/components/form/select/multiSelectFormik";

const HumanResourceCreate = () => {
  ...
  return (
    ...
    >
      <Row gutter={[16, 16]}>
        ...
        {/* HumanResource ID Bank */}
        <Col xs={24} sm={24} md={12} lg={12}>
          <Field
            label={t('humanresourceIdBank')}
            name="humanresourceIdBank"
            component={FormInput}
            placeholder={t('enterHumanResourceIdBank')}
            variant="outlined"
            size="large"
          />
        </Col>
