...
import { VelenjakReservationAllowableRow } from './types';
...
const renderStatus = (_: number | null, record?: VelenjakReservationAllowableRow) => (
  <Tag
...
export const getColumns = (pagination?: { current: number; size: number }) => [
  ...
  createColumn({
    ...
    sortable: true,
    ellipsis: true,
    render: (value: string, record?: VelenjakReservationAllowableRow) => (
  ...
  createColumn({
    ...
    width: 130,
    sortable: true,
    render: (_: boolean | null, record?: VelenjakReservationAllowableRow) => (
      <Space size="small">
